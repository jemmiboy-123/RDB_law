    ...
    <section className="stack">
      <form className="panel form-grid" onSubmit={submit}>
        ...
        <div className="two-col compact">
          <label>Full Name<input placeholder="e.g. Maria Santos" value={form.full_name} onChange={(e) => setForm({ ...form, full_name: e.target.value })} /></label>
          ...
          <label>Password<input type="password" placeholder="Temporary password" value={form.password} onChange={(e) => setForm({ ...form, password: e.target.value })} /></label>
          <label>Role
